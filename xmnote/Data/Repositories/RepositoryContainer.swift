...
/**
 * [INPUT]: 依赖 DatabaseManager、统一会员权益、导出与各 Repository 实现及可注入 UserDefaults 完成生产或 Debug 隔离组装
 * [OUTPUT]: 对外提供 RepositoryContainer，集中暴露业务仓储与 exportRepository，并在 Debug 提供 Sheet 数据副本的隔离组装入口
