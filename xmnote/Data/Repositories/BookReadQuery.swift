...
/**
 * [INPUT]: 依赖 GRDB Database 与 book、note、chapter、attach_image、tag、tag_note、category、category_content、review、read_status、source、read_time_record 表读取书籍展示数据
 * [OUTPUT]: 对外提供 BookReadQuery（书籍卡片、书籍选择、书籍详情与单书四域内容只读查询）
