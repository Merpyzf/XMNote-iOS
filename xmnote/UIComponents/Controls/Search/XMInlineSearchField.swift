 ...
 * [POS]: UIComponents/Controls/Search 的内容区搜索基础组件，被管理页与笔记页的可滚动搜索头复用
...
struct XMInlineSearchField: View {
    ...
    @ScaledMetric(relativeTo: .subheadline) private var cancelButtonWidth = XMInlineSearchFieldMetrics.cancelButtonBaseWidth
    ...
    var body: some View {
        ...
        .frame(maxWidth: .infinity, minHeight: XMInlineSearchFieldMetrics.minimumTouchTarget)
    ...
    private var cancelButton: some View {
        if cancelPresentation == .automatic {
            Button("取消", action: cancelSearch)
                ...
                .frame(minHeight: XMInlineSearchFieldMetrics.minimumTouchTarget)
...
private enum XMInlineSearchFieldMetrics {
    ...
    static let minimumTouchTarget: CGFloat = InteractionMetrics.minimumTouchTarget
    static let cancelButtonBaseWidth: CGFloat = InteractionMetrics.minimumTouchTarget
