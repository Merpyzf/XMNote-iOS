/**
 * [INPUT]: 依赖 SwiftUI Shape/View 与 DesignTokens 的评分激活语义色，复用 Android Fluent 星形路径
 * [OUTPUT]: 对外提供 XMFluentStarIcon 与 XMFluentStarShape，统一评分和章节星标的圆润填充星形
 * [POS]: UIComponents/Foundation 跨模块星形基础设施，被 XMRatingBar 与星标章节展示消费
...
struct XMFluentStarIcon: View {
    ...
    init(size: CGFloat = 16, color: Color = .ratingActive) {
        self.size = size
        self.color = color
    }
