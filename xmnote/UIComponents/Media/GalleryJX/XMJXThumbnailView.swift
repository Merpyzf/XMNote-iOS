 ...
 * [POS]: UIComponents/Media/GalleryJX 的 SwiftUI->UIKit 桥接层，为 JXPhotoBrowser Zoom 转场提供可回溯的真实 UIView 缩略图来源
...
struct XMJXThumbnailView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIImageView {
        ...
        imageView.backgroundColor = UIColor.xmResolved(Color.surfaceCard)
