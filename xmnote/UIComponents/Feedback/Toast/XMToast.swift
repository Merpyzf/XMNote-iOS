 ...
 * [POS]: UIComponents/Feedback/Toast 的全局 Toast 基础设施，隐藏 PopupView 具体实现并收敛消息提示样式、布局、动效与交互
...
/// Toast 组件内部的非状态外观，避免把信息提示误映射为选中语义。
private enum XMToastAppearance {
    static let infoTint = Color.xmHex(0x2DA44F)
}
...
enum XMToastRole: String, Sendable {
    ...
    var tintColor: Color {
        ...
        case .info:
            return XMToastAppearance.infoTint
        case .processing:
            return .appTint
        }
    }
