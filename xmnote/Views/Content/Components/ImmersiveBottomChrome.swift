/**
 * [INPUT]: 依赖 SwiftUI 安全区扩展能力与 DesignSystem 颜色、间距和交互尺寸令牌
 * [OUTPUT]: 为 Content viewer 流程提供 ImmersiveBottomChromeMetrics、ImmersiveBottomChromeOverlay、ImmersiveBottomChromeIcon 与高度偏好键
 * [POS]: Views/Content/Components 的页面私有底部沉浸表层，仅服务 Content viewer 的渐变托底、悬浮操作和滚动避让
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 */

import SwiftUI

/// Content viewer 底部 chrome 的尺寸常量，统一控制可视高度与命中目标。
enum ImmersiveBottomChromeStyle {
    static let controlHeight: CGFloat = 50
    static let minimumHitTarget: CGFloat = InteractionMetrics.minimumTouchTarget
...
/// Content viewer 的底部沉浸 overlay，承接渐变托底与悬浮 ornament 的安全区延展。
...
/// Content viewer 底部 ornament 的统一图标尺寸与点击热区。
