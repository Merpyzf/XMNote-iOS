/**
 * [INPUT]: 依赖 AITextResultViewModel/AIAutoTagViewModel、AIRepositoryProtocol、AIMarkdownResultView、XMPopupButton、系统 NavigationStack/Toolbar/safeAreaBar、iOS 26 Liquid Glass、LoadingGate 与现有反馈组件
 * [OUTPUT]: 对外提供 AITextResultSheet 与 AIAutoTagSheet；AI 释义以等高 Popup 指示器的可点击模型副标题和底部品牌玻璃操作承接模型切换与编辑器请求，AI 标签保持系统确认与写回生命周期
