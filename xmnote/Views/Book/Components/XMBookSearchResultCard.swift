 ...
 * [POS]: Views/Book/Components 的书籍搜索私有卡片，服务生产搜索结果与同场景 Debug 验证
...
/// 公共书籍搜索结果卡片的局部排版语义。
private enum XMBookSearchResultTypography {
    static let titleHighlight: Font = AppTypography.semantic(.headline, weight: .bold)
}
        ...
        HStack(alignment: .top, spacing: Spacing.base) {
            ...
            VStack(alignment: .leading, spacing: Spacing.cozy) {
                XMKeywordHighlighting.text(
                    result.title,
                    keyword: keyword,
                    baseFont: AppTypography.headlineSemibold,
                    highlightFont: XMBookSearchResultTypography.titleHighlight,
