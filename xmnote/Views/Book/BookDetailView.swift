...
/**
 * [INPUT]: 依赖 RepositoryContainer 注入书籍与内容仓储，依赖 BookDetailViewModel 驱动状态，依赖 XMBookRatingSheet 与 NoteRoute/ContentRoute/BookRoute 承接评分、排序、目录管理、相关书编辑和笔记域导航
 * [OUTPUT]: 对外提供 BookDetailView，展示书籍资料、可写评分、可点击/管理目录、可持久化排序的书摘/书评/相关内容工作区、相关书编辑入口及异常状态
 * [POS]: Book 模块详情壳层，通过导航接收 bookId，并以当前 iOS 设计系统承接 Android 书内笔记管理业务能力
