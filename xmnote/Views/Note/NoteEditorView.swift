/**
 * [INPUT]: 依赖 RepositoryContainer 注入 Note/图片额度 Repository，依赖 AppState 提供会员状态，依赖 NoteEditorViewModel 驱动完整书摘编辑状态，依赖 NoteTextComposerView 与 BookPickerView 承接富文本输入和书籍选择
 * [OUTPUT]: 对外提供 NoteEditorView，承载书摘新建/编辑、草稿恢复、附图、层级章节/标签选择与保存动作
