/**
 * [INPUT]: 依赖 GRDB 的 DatabasePool/DatabaseMigrator 与 RoomCanonicalSchemaV45 提供持久化和版本合同
...
nonisolated struct AppDatabase {
    ...
    static let databaseVersion = RoomCanonicalSchemaV45.databaseVersion
...
extension AppDatabase {
    ...
    private nonisolated static func openDatabase(at path: String) throws -> DatabasePool {
        ...
        // 兼容 Android Room：恢复库达到 canonical v40...v45 但缺少 grdb_migrations 时，
