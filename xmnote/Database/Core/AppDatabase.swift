/**
 * [INPUT]: 依赖 GRDB 的 DatabasePool/DatabaseMigrator 与 RoomCanonicalSchemaV48 提供持久化和版本合同
...
nonisolated struct AppDatabase {
    ...
    static let databaseVersion = RoomCanonicalSchemaV48.databaseVersion
...
extension AppDatabase {
    ...
    private nonisolated static func openDatabase(at path: String) throws -> DatabasePool {
        ...
        // 兼容 Android Room：恢复库达到 canonical v40...v48 但缺少 grdb_migrations 时，
