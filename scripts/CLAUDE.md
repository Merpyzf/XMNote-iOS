...
- `verify_component_guides.sh`: 校验重要 UI 组件使用文档清单、路径与文档必备章节是否完整。
...
执行约束
- 提交前执行：`bash scripts/verify_glossary.sh && bash scripts/verify_ui_glossary_scope.sh && bash scripts/verify_arch_docs_sync.sh && bash scripts/verify_component_guides.sh`。
