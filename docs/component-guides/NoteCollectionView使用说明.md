# NoteCollectionView 使用说明

## 组件定位
- 源码路径：xmnote/Views/Note/NoteCollectionView.swift
- 角色：NoteCollectionView 页面核心组件，承载对应功能主流程与关键交互。
...
## 参数说明
- 该组件对外参数以源码声明为准：xmnote/Views/Note/NoteCollectionView.swift
