...
| XMContentStateView | `xmnote/UIComponents/Feedback/StatePresentation/XMContentStateView.swift` | `docs/component-guides/XMStatePresentation使用说明.md` | 已完成 |
| XMCompactStateView | `xmnote/UIComponents/Feedback/StatePresentation/XMCompactStateView.swift` | `docs/component-guides/XMStatePresentation使用说明.md` | 已完成 |
| XMInlineStatusBanner | `xmnote/UIComponents/Feedback/StatePresentation/XMInlineStatusBanner.swift` | `docs/component-guides/XMStatePresentation使用说明.md` | 已完成 |
| LoadingStateView | `xmnote/UIComponents/Feedback/LoadingStateView.swift` | `docs/component-guides/XMStatePresentation使用说明.md` | 已完成 |
| LoadPhaseHost | `xmnote/UIComponents/Feedback/Loading/LoadingFeedbackKit.swift` | `docs/component-guides/XMStatePresentation使用说明.md` | 已完成 |
...
| ChapterManagerView | `xmnote/Views/Book/ChapterManagerView.swift` | `docs/component-guides/ChapterManagerView使用说明.md` | 已完成 |
...
| NoteContainerView | `xmnote/Views/Note/NoteContainerView.swift` | `docs/component-guides/NoteContainerView使用说明.md` | 已完成 |
