...
- Models/ContentViewerModels.swift: 定义 ContentViewerSourceContext、ContentViewerItemID、ContentViewerListItem、ContentViewerDetail 等通用内容查看领域模型。
...
- Repositories/RepositoryProtocols.swift: 定义 Book、Note、Content、BackupServer、Backup、Statistics、ReadCalendarColor、Timeline、ReadingDashboard 九类仓储契约。
