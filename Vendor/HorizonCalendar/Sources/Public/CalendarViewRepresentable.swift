...
public struct CalendarViewRepresentable: UIViewRepresentable {
  ...
  public func updateUIView(_ calendarView: CalendarView, context _: Context) {
    ...
    calendarView.didScrollHorizontalMonthPagingProgress = didScrollHorizontalMonthPagingProgress
  ...
  fileprivate var didScrollHorizontalMonthPagingProgress: ((HorizontalMonthPagingProgressContext) -> Void)?
...
extension CalendarViewRepresentable {
  ...
  /// Configures the handler for horizontal month paging progress interpolation updates.
  public func onHorizontalMonthPagingProgress(
    _ progressHandler: @escaping (HorizontalMonthPagingProgressContext) -> Void
  ) -> Self {
    var view = self
    view.didScrollHorizontalMonthPagingProgress = progressHandler
    return view
  }
